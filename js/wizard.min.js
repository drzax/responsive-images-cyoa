 ...
 */
var Wizard=function(e,t){e(function(){function n(){var t,n,i,o;a.removeClass("excluded");for(t in r)for(n in r[t])i=r[t][n],a.each(function(){var t=e(this);t.is("#"+i)&&t.addClass("excluded")});return o=a.not(".excluded").length,s.html(o),1>=o&&(e("#result").removeClass("count-1").removeClass("count-0").addClass("count-"+o),window.location="#/result"),o}var r=[],i=!1,o=[],a=e("#solutions div.solution"),s=e("#solutions-count span");s.html(a.not(".excluded").length),a.find("a").attr("target","_blank"),Reveal.addEventListener("slidechanged",function(e){var t="#/"+e.indexh;e.indexv>0&&(t+="/"+e.indexv),_gaq&&_gaq.push(["_trackPageview",t.path]),o.push(t),o.length>2&&o.shift()}),e(document).on("click",".responses button",function(){var i=e(this),o=Reveal.getIndices(),a=i.data("exclude"),s=i.data("next")?Reveal[i.data("next")]:Reveal.right;i.addClass("btn-success").siblings("button").removeClass("btn-success"),r[o.v+"/"+o.h]=a===t?[]:a.split(","),n(),n()>1&&s()}),e(document).on("click",".responses span",function(){var t=e(this),n=t.parents("section").first();n.toggleClass("help")}),e(document).on("click","button.start",function(){i=!0,Reveal.next()}),e(document).on("click","button.prev",function(){window.location=o[0]}),e(document).on("click","button.restart",function(){r=[],e("button").removeClass("btn-success"),n(),window.location="#"})})}(jQuery);