 ...
 */
var Wizard=function(e,t){e(function(){function n(){var t,n,a;i.removeClass("excluded");for(t in r)for(n in r[t])a=r[t][n],i.each(function(){var t=e(this);t.is("#"+a)&&t.addClass("excluded")});o.html(i.not(".excluded").length)}var r=[],i=e("#solutions div.solution"),o=e("#solutions-count span");o.html(i.not(".excluded").length),e(document).on("click",".responses button",function(){var i=e(this),o=Reveal.getIndices(),a=i.data("exclude"),s=i.data("next")?Reveal[i.data("next")]:Reveal.right;i.addClass("btn-success").siblings("button").removeClass("btn-success"),r[o.v+"/"+o.h]=a===t?[]:a.split(","),n(),s()}),e(document).on("click",".responses span",function(){var t=e(this),n=t.parents("section").first();n.toggleClass("help")})})}(jQuery);