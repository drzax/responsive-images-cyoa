 ...
 */
var Wizard=function(e,t){e(function(){function n(){var t;t=e(Reveal.getCurrentSlide()),t.hasClass("question")||t.hasClass("answers")?(e("#solutions-count").show(),s.find("button.restart").css("display","inline"),o.length&&s.find("button.back").css("display","inline")):(e("#solutions-count").hide(),s.find("button").hide())}function r(){var n;return n=[],a.removeClass("excluded"),e(".responses button.selected").each(function(){var r=e(this).data("exclude");n+=r===t?[]:r.split(",")}),a.each(function(){var t=e(this);n.indexOf(t.attr("id"))>-1&&t.addClass("excluded")}),count=a.not(".excluded").length,u.html(count),count}function i(e){var n;return e===t&&(e=Reveal.getIndices()),n="#/"+e.h,e.v>0&&(n+="/"+e.v),n}var o=[],a=e("#solutions div.solution"),s=e("#question-nav"),u=e("#solutions-count span");u.html(a.not(".excluded").length),a.find("a").attr("target","_blank"),n(),Reveal.addEventListener("slidechanged",function(e){_gaq&&_gaq.push(["_trackPageview",i({h:e.indexh,v:e.indexv})]),n()}),e(document).on("click",".responses button:not(.more-toggle)",function(){var t;t=e(this),t.addClass("selected").siblings("button").removeClass("selected"),e(Reveal.getCurrentSlide()).hasClass("question")&&o.push(i()),r()>1?(t.data("next")?Reveal[t.data("next")]:Reveal.right)():(e("#result").removeClass("count-1").removeClass("count-0").addClass("count-"+count),window.location="#/result")}),e(document).on("click",".more-toggle",function(){var t=e(this).parents("section").first();t.toggleClass("show-more"),e(this).text(t.hasClass("show-more")?"Less":"More")}),e(document).on("click","button.start",function(){Reveal.next()}),e(document).on("click","button.back",function(){var e=o.pop();return e!==t&&(window.location=e),(e===t||1>o.length)&&s.find("button.back").hide(),!1}),e(document).on("click","button.restart",function(){return e("button").removeClass("selected"),r(),o=[],window.location="#/start",!1})})}(jQuery);